#How to run
#python emotion_recognition_image.py --cascade haarcascade_frontalface_default.xml --model EmotionDetectionModel-ferdataset.h5 --i 1.jpeg
#python emotion_recognition_image.py --cascade haarcascade_frontalface_default.xml --model EmotionDetectionModel-81132-sofar-ok.h5 --i 1.jpg
# coding: utf-8
...
EMOTIONS = ["Bored", "Confused", "Excited", "Others"]
